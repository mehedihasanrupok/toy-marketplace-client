            ...
            <div className='rounded mt-3 mx-auto bg-slate-500'>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 gap-6 bg-red-400'>
                    <div className="form-control">
                        ...
                        <input type="text" defaultValue={toyName} name='name' className="input input-bordered" />
                    </div>
                    <div className="form-control">
                        <label className="label">
                    ...
                    <div className="form-control">
                        ...
                        <input type="text" name='details' defaultValue={details} className="input input-bordered btn-block" />
                    </div>
                </div>
                </form>
            </div>
